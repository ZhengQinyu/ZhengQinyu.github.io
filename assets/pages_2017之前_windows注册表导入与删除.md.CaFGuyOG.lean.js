import{_ as a,c as n,a2 as p,o as e}from"./chunks/framework.BQmytedh.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"pages/2017之前/windows注册表导入与删除.md","filePath":"pages/2017之前/windows注册表导入与删除.md","lastUpdated":1733298232000}'),t={name:"pages/2017之前/windows注册表导入与删除.md"};function o(l,s,i,c,d,u){return e(),n("div",null,s[0]||(s[0]=[p(`<p>注册表导入与删除</p><p>增加文件，文件格式是<code>.reg</code>。导入如下格式：</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>Windows Registry Editor Version 5.00  </span></span>
