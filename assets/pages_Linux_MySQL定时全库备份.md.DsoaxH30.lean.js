import{_ as s,c as n,a2 as p,o as e}from"./chunks/framework.BQmytedh.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"pages/Linux/MySQL定时全库备份.md","filePath":"pages/Linux/MySQL定时全库备份.md","lastUpdated":1732945848000}'),l={name:"pages/Linux/MySQL定时全库备份.md"};function i(d,a,c,t,o,b){return e(),n("div",null,a[0]||(a[0]=[p(`<h3 id="_1-备份脚本" tabindex="-1">1. 备份脚本 <a class="header-anchor" href="#_1-备份脚本" aria-label="Permalink to &quot;1. 备份脚本&quot;">​</a></h3><p>在文件夹 <code>/home/zqyu/database_bak</code> 下创建脚本文件 <code>db-backup.sh</code>, 数据库账号是<code>root</code>,密码是<code>123456</code>, <code>backupSize</code>表示要保留的备份文件数量，备份 db_1，db_2，db_3三个数据库</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>#!/bin/bash</span></span>
