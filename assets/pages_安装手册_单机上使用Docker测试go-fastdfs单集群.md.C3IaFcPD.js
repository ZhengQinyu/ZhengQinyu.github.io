...
<span class="line"><span></span></span>
<span class="line"><span>        }</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>重启nginx后，访问 <code>http://file.izqy.top</code>测试上传了下载，检查上传的文件是否同时保存到 <code>/opt/fastdfs_data1/files/default</code> 和 <code>/opt/fastdfs_data2/files/default</code>中。</p>`,22)]))}const h=a(t,[["render",o]]);export{q as __pageData,h as default};
