import{_ as n,c as a,a2 as p,o as l}from"./chunks/framework.BQmytedh.js";const o=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"pages/2017之前/汇编记录.md","filePath":"pages/2017之前/汇编记录.md","lastUpdated":1732945848000}'),e={name:"pages/2017之前/汇编记录.md"};function i(c,s,t,E,A,D){return l(),a("div",null,s[0]||(s[0]=[p(`<p>汇编基础习题</p><h4 id="题1" tabindex="-1">题1 <a class="header-anchor" href="#题1" aria-label="Permalink to &quot;题1&quot;">​</a></h4><p>编写一个程序，计算$\\frac{X*Y-Z}{X}$的值。其中X、Y、Z均为16位带符号数，要求表达式的计算结果存放在数据段的RESULT单元中。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>DATA SEGMENT</span></span>
...
<span class="line"><span>END START</span></span></code></pre></div><h4 id="题2" tabindex="-1">题2 <a class="header-anchor" href="#题2" aria-label="Permalink to &quot;题2&quot;">​</a></h4><p>设某班学生（10名）某门课程的成绩存放在内存中，试编程统计90分以上、80-89分、70-79分、60-69分、低于60分的学生人数，并分别存放到A、B、C、D、E单元中。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>DATA  SEGMENT</span></span>
...
<span class="line"><span>  JMP $</span></span>
<span class="line"><span> CODE ENDS</span></span>
<span class="line"><span>END START</span></span></code></pre></div><h4 id="题3" tabindex="-1">题3 <a class="header-anchor" href="#题3" aria-label="Permalink to &quot;题3&quot;">​</a></h4><p>用主程序、子程序结构实现判断textdata（10个单元）中的数据是否为“0”~“F”的ASCII码。若是，用十六进制数覆盖原单元，否则用0FFH覆盖原单元。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>DATA SEGMENT</span></span>
