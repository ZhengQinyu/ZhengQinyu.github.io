import{_ as n,c as a,a2 as p,o as l}from"./chunks/framework.BQmytedh.js";const o=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"pages/2017之前/汇编记录.md","filePath":"pages/2017之前/汇编记录.md","lastUpdated":1733298232000}'),e={name:"pages/2017之前/汇编记录.md"};function i(c,s,t,E,A,D){return l(),a("div",null,s[0]||(s[0]=[p(`<p>汇编基础习题</p><h4 id="题1" tabindex="-1">题1 <a class="header-anchor" href="#题1" aria-label="Permalink to &quot;题1&quot;">​</a></h4><p>编写一个程序，计算$\\frac{X*Y-Z}{X}$的值。其中X、Y、Z均为16位带符号数，要求表达式的计算结果存放在数据段的RESULT单元中。</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>DATA SEGMENT</span></span>
