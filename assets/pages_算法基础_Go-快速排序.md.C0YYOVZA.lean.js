import{_ as n,c as a,a2 as t,o as p}from"./chunks/framework.BQmytedh.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"pages/算法基础/Go-快速排序.md","filePath":"pages/算法基础/Go-快速排序.md","lastUpdated":1732945848000}'),l={name:"pages/算法基础/Go-快速排序.md"};function e(i,s,c,o,r,u){return p(),a("div",null,s[0]||(s[0]=[t(`<h2 id="快速排序" tabindex="-1">快速排序 <a class="header-anchor" href="#快速排序" aria-label="Permalink to &quot;快速排序&quot;">​</a></h2><ul><li>算法实现</li></ul><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>func partition(nums []int, left int, right int) int {</span></span>
